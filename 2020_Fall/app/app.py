...
#
#
# balance = web3.eth.getBalance("0x5A0b54D5dc17e0AadC383d2db43B0a0D3E029c4c")
...
#
# ## Sign transaction
# print("Transaction raw: " + str(tx))
# signed_tx = web3.eth.account.signTransaction(tx, sender_private_key)
#
# print("Sender signed Transaction:" + str(signed_tx))
# ## Send transaction
...
## Redirect to a new page to allow user to send an amount
...
## The send amount POST call that allows interaction
## between front end and making a transaction call
